          ...
          <div class="package_top_grid">
            ...
            <div class="col-md-6">
              <div class="packages_right" style="height: 340px">
                <h3>Introduction</h3>
                <p>
                  Our project focuses on the analysis of social media data from platforms 
                  like Twitter and Mastodon to gain insights into the sentiment and happiness 
                  of Australians during the elections. With the increasing usage of social media, 
                  particularly among the younger generation, this dataset has become a powerful tool
                  for understanding public opinion and potentially predicting election results.
                </p>
              </div>
            </div>
          ...
          <div class="package_middle_grid">
            <div class="col-md-6">
              <div class="packages_right packages_right1">
                <h3>Dashboard</h3>
                <ul>
                    <li>A visual representation of the relationship between people's
                   sentiment on Twitter and its relevance to elections. </li>
                    <li>Explore the interactive charts 
                  and graphs to analyze sentiment trends over time and their potential impact on 
                  election outcomes.</li>
                    <li>Gain valuable insights into the electorate's sentiment by examining sentiment analysis results.</li>
                </ul>
                <p>
                  A visual representation of the relationship between people's
                   sentiment on Twitter and its relevance to elections. 
                </p>
                <p>
                ...
                <p>
                  Gain valuable insights into the electorate's sentiment by examining sentiment analysis results.
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="packages_left1"></div>
            </div>
            <div class="clearfix"></div>
          </div>
