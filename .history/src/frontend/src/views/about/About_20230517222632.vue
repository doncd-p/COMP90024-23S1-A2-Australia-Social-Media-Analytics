                ...
                <li>
                  <div class="w3l-info1">
                    ...
                    <div class="col-md-9 testimonials-grid-2">
                      <h4>Developers</h4>
                      <h5>Chenyang Dong, Lang Chen, Un Leng Kam, Ying Zhu, Zhuoya Zhang</h5>
                      <p>
                ...
                <li>
                  <div class="w3l-info1">
                    ...
                    <div class="col-md-9 testimonials-grid-2">
                      <h4>Contacts</h4>
                      <p>
                        <i class="fa fa-quote-left" aria-hidden="true"></i>For any inquiries or feedback, feel free to reach out to us at:
                        Email: elefeel@gmail.com
                        LinkedIn: linkedin.com/in/elecfeel-profile 
                        We are available to assist you and answer any questions you may have.
