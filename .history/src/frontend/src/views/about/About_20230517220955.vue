          ...
          <div class="package_middle_grid">
            <div class="col-md-6">
              <div class="packages_right packages_right1">
                <h3>Dashboard</h3>
                <p>
                  The dashboard presents a visual representation of the relationship between people's
                   sentiment on Twitter and its relevance to elections. Explore the interactive charts 
