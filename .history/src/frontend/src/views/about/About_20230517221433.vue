          ...
          <div class="package_middle_grid">
            <div class="col-md-6">
              <div class="packages_right packages_right1">
                <h3>Dashboard</h3>
                <p>
                  A comprehensive dashboard that offers a visual representation of 
                  the relationship between people's sentiment on Twitter and its 
                  relevance to elections. Through interactive charts and graphs, 
                  you can analyze sentiment trends over time and explore their potential
                   impact on election outcomes. Gain valuable insights into the electorate's
                    sentiment by examining sentiment analysis results.
                </p>
