          ...
          <div class="package_middle_grid">
            <div class="col-md-6">
              <div class="packages_right packages_right1">
                <h3>Significance</h3>
                <p>
                  By utilizing social media data as an alternative to traditional polling methods,
                  we aim to provide valuable insights into the sentiment of the electorate during elections.
                  This project acknowledges the growing significance of social media platforms as platforms
                  for political engagement and seeks to contribute to the field of political analysis in 
                  the digital era.
                </p>
              </div>
            </div>
