          ...
          <div class="package_middle_grid">
            <div class="col-md-6">
              <div class="packages_right packages_right1">
                ...
                <p>
                  By leveraging social media data, we aim to provide an alternative approach to
                  traditional polling methods used by Non-Government Agencies and newspapers. 
                  This project recognizes the changing dynamics of political engagement, where 
                  social media platforms have become a prominent platform for expressing opinions 
                  and discussing political matters. We believe that analyzing social media data
                  can offer valuable insights into the electorate's sentiment, contributing to the
                  field of political analysis in the technological age.
                </p>
                <a
