...
class BoardDailyAvgSentimentAll(Resource):
    def get(self):
        try:
...
class BoardWeeklyAvgSentimentAll(Resource):
    def get(self):
        try:
            ...
            #     key: weekly_AUS_sentiment_sum_count[key]['sum']/weekly_AUS_sentiment_sum_count[key]['count'] for key in weekly_AUS_sentiment_sum_count}
...
class BoardMonthlyAvgSentimentAll(Resource):
    def get(self):
        try:
            startdate = request.args.get('startdate', '2022-02-10')
            enddate = request.args.get('enddate', '2022-05-21')
